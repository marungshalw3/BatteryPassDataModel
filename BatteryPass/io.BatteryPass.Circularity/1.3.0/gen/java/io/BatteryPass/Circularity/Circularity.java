...
/**
 * Generated class for Circularity
 * (urn:samm:io.BatteryPass.Circularity:1.3.0#Circularity). Dismantling
 * information (including at least: exploded diagrams of the battery system/pack
 * showing the location of battery cells; disassembly sequences; type and number
 * of fastening techniques to be unlocked; tools required for disassembly;
 * warnings if risk of damaging parts exists; amount of cells used and layout);
 * part numbers for components and contact details of sources for replacement
 * spares; safety measures (Annex XIII (2b-d)); usable extinguishing agent
 * (Annex VI, Part A(9)). 2024 Circulor (for and on behalf of the Battery Pass
 * Consortium). This work is licensed under a Creative Commons License
...
public class Circularity {
	...
	/**
	 * Returns dismantling and removal information
	 *
	...
	/**
	 * Returns end of life information
	 *
