...
/**
 * Generated class for material composition
 * (urn:samm:io.BatteryPass.MaterialComposition:1.3.0#MaterialComposition).
 * Mandatory data: Battery chemistry; critical raw materials; materials used in
 * the cathode, anode, and electrolyte; hazardous substances; impact of
 * substances on the environment and on human health or safety
 * 
