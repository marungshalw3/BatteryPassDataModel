...
/**
 * Generated class for CarbonFootprintForBatteries
 * (urn:samm:io.BatteryPass.CarbonFootprint:1.3.0#CarbonFootprintForBatteries).
 * The battery passport must contain carbon footprint per functional unit of the
 * battery as declared in the battery carbon footprint declaration in accordance
 * with the entry into force of the implementing acts on the format of
 * declaration. Reference: REGULATION (EU) 2023/1542 aka EU Battery Regulation
 */
